...
\begin{frame}
	...
	\begin{tikzpicture}
		...
		(0,0.5) -- (3.7,0.5) node [.,midway,yshift=15pt,xshift=3.4cm] {Kommentar: wird vom Computer \textbf{ignoriert}, ist für Menschen \textbf{nützlich}};
	\end{tikzpicture}
	...
	\begin{minipage}[b]{0.4\textwidth}
		\begin{tikzpicture}
			...
			(0,0.5) -- (1,0.5) node [.,midway,yshift=-15pt] {Befehl};
		\end{tikzpicture}
	\end{minipage}
	\pause
	\hskip -4.8cm
	\begin{minipage}[b]{0.4\textwidth}
		\begin{tikzpicture}
			\draw [decorate,decoration={mirror,brace,amplitude=6pt}]
			(1.1,0.5) -- (3.35,0.5) node [.,midway,yshift=-15pt] {Text};
		\end{tikzpicture}
	\end{minipage}
...
\begin{frame}
	\slidehead
	\begin{itemize}
		\item Computer benutzen meist Dateisysteme um Dateien zu organisieren
	...
	\begin{columns}[T]
		\begin{column}{.4\textwidth}
			\begin{tikzpicture}
				...
				\node[fill=lightpetrol,draw, inner sep=5pt,rounded rectangle] (python) at (0,-4) {\texttt{python helloworld.py}};
