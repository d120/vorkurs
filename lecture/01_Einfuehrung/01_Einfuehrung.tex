...
\section{Vom Quelltexts zum fertigen Programm}
\begin{frame}
	\slidehead
	...
	\begin{columns}[T]
		...
		\begin{column}{.6\textwidth}
			\begin{itemize}
				\item Dateiname des Quelltexts hat die Endung \texttt{.py}
				\item Name der Datei sollte sinnvoll gewählt werden
				\pause
...
\begin{frame}[fragile]
	\slidehead
	\begin{itemize}
		\item Python teilt Fehler bei der Ausführung mit
		\item Fehler werden erst angezeigt, wenn sie erreicht wurden
		\pause
		\item \textbf{Achtung:} Nicht immer liegt der Fehler in der Zeile, die angegeben ist
	\end{itemize}
	...
	\pythonfile{listings/synError1_Listing.txt}
