...
\titlegraphic{
    \begin{columns}[b]
        \begin{column}{.4\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[height=.55\textheight]{computer1917.jpg}
        ...
        \begin{column}{.4\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[height=.55\textheight]{Z3_Deutsches_Museum.JPG}
...
\begin{frame}
    ...
    \begin{columns}[b]
        \begin{column}{.3\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{punchcards.png}
        ...
        \begin{column}{.4\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[height=.58\textheight]{apollo_code.png}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{ 0.3\textwidth }
            \begin{figure}
                \includegraphics{receipt.jpg}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}

\subsection{Die Sprachen der Computer}
\begin{frame}
    \slidehead
    \begin{itemize}[<+->]
        \item Was definiert die Schreibweise eines Programms?
            % Hier ist die Analoge mit den Aliens gut angebracht
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{ 0.3\textwidth }
            \begin{figure}
                \includegraphics[width=\textwidth]{python.jpg}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{columns}[T]
        \begin{column}{2cm}
            \begin{tikzpicture}
                \node[] (mensch) at (0,0) {\includegraphics[height=1.3cm]{media/wesen_notebook\IfDarkModeT{-dark}.png}};

                \visible<2->{
                    \node[fill=lightpetrol,draw, inner sep=5pt,rounded rectangle] (interpreter) at (0,-1.8) {Python};
        ...
        \begin{column}{10cm}
            \begin{itemize}
                ...
                \item[]
                    \visible<2->{
                \item \textbf{Python} übersetzt den Quelltext in Anweisungen für den Computer
                    }
                \item[]
                \item[]
                    \visible<3->{
                \item \textbf{Der Computer} führt die Anweisungen aus
                    }
            \end{itemize}
        \end{column}
    \end{columns}
