...
\begin{frame}
	...
	%			\pythonfile{listings/String_Listing8.py}
	%		\begin{block}{Wichtig}
	%			\begin{itemize}
	...
	%			\pythonfile{listings/String_Listing9.py}
	%		\begin{block}{Wichtig}
	%			\begin{itemize}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\pythonfile{listings/String_Listing10.py}

			\item Umwandeln in Kleinbuchstaben
			\pythonfile{listings/String_Listing11.py}

			\item Umwandeln in Großbuchstaben
			\pythonfile{listings/String_Listing12.py}
		\end{itemize}
	\end{frame}
	...
	\begin{frame}
		...
		\pythonfile{listings/String_Listing13.py}
	...
	\begin{frame}
		...
		\begin{block}{Beispiel}
			\pythonfile{listings/String_Listing14.py}
		\end{block}
	\end{frame}
