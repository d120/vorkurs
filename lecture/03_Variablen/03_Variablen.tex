...
\begin{frame}
    ...
    \visible<2->{
        \begin{itemize}
            ...
            \item Bei Auswertung zu \kotlininline{false} wird der Block übersprungen, bei \pythoninline{true} wird dieser ausgeführt
        \end{itemize}}
    \pythonfile{listings/if_anweisung.kts}
    \visible<3->{
        \begin{block}{Hinweis}
            \begin{itemize}
...
\begin{frame}
    \slidehead
    \vspace{-1em}
    \kotlinfile{listings/if_bsp1.kts}
\end{frame}
...
\begin{frame}
    ...
    \vspace{-0.1cm}
    \begin{itemize}
        \item Logisches \textbf{Nicht} (\kotlininline{!})  $\Rightarrow$ \pythoninline{not Ausdruck1}
        \item Logisches \textbf{Und} (\kotlininline{&&}) $\Rightarrow$ \pythoninline{Ausdruck1 and Ausdruck2}
        \item Logisches \textbf{Oder} (\kotlininline{||})  $\Rightarrow$ \pythoninline{Ausdruck1 or Ausdruck2}
    \end{itemize}
    \vspace{-0.15cm}
    \begin{block}{Beispiel:}
        \pythonfile{listings/logische_operatoren_listing.kts}
    \end{block}
    \vspace{-0.15cm}
    \begin{block}{Hinweis}
        \begin{itemize}
