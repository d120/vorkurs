...
\begin{frame}[t]
	...
	\begin{columns}
		...
		\begin{column}{7cm}
			\begin{figure}
				\includegraphics[width=\textwidth]{rekursion}
				% Code to recursively generate recurvive picture
				%				\includegraphics[width=\textwidth,page=23]{06_Funktionen1.pdf}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}[t]
	...
	\begin{columns}
		\begin{column}{5cm}
			\begin{figure}
				\includegraphics[width=\textwidth]{rekursion_mehrfach}

				% Code to recursively generate recurvive picture
				%\includegraphics[width=\textwidth,page=18]{Funktionen1.pdf}
			\end{figure}
		\end{column}
