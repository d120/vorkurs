...
\begin{frame}[c]
    \slidehead
    \kotlinfile{listings/beispiel_schlecht.kts}
...
\begin{frame}
    \slidehead
    \kotlinfile{listings/beispiel_gut.kts}
\end{frame}
...
\begin{frame}
    ...
    \vspace{1cm}
    \begin{block}{Hinweis}
        Einige Funktionen haben wir schon kennengelernt, z.B. \kotlininline{println("Hello World")}
    \end{block}
\end{frame}
...
\begin{frame}[c]
    \slidehead
    \begin{itemize}[<+->]
        \item Syntax: \kotlinfile{listings/fun_syntax.kts}
        \item Beispiel: \kotlinfile{listings/fun_syntax_concrete.kts}
    \end{itemize}
\end{frame}
...
\begin{frame}
    \slidehead
    \begin{itemize}
        \item in Kotlin wird Funktionsdokumentation mit drei doppelten Anführungszeichen eingeleitet
...
\begin{frame}
    \slidehead
    \kotlinfile{listings/fun_example_return_block.kts}
    \pause
    Funktionen, die nur die \kotlininline{return}-Anweisung haben, können auch so geschrieben werden
    \kotlinfile{listings/fun_example_return_expression.kts}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{figure}
        ...
        %Viele Grüße
        %Kevin
        \includeinvertablegraphics[width=0.6\textheight]{geometrie}
        \caption{Flächeninhalt eines Kreises}\label{fig:flaecheninhalt}
    \end{figure}
...
\begin{frame}
    \slidehead
    \kotlinfile{listings/bsp_geometrie_schlecht.kts}
...
\begin{frame}
    \slidehead
    \begin{onlyenv}<1>
        \kotlinfile{listings/bsp_geometrie_1.kts}
    \end{onlyenv}

    \begin{onlyenv}<2>
        \kotlinfile{listings/bsp_geometrie_2.kts}
    \end{onlyenv}
...
\begin{frame}
    \slidehead
    \vspace{-1ex}
    \kotlinfile[][top=0cm,bottom=0cm]{listings/reusability.kts}
    \vspace{-1ex}
    \begin{block}{Hinweis}
...
\begin{frame}
    \slidehead
    \kotlinfile{listings/scope_2.kts}
    \begin{itemize}
...
\begin{frame}
    \slidehead
    \kotlinfile{listings/scope_3.kts}
    \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Fibonacci-Zahlen: \texttt{1, 1, 2, 3, 5, 8, 13, 8+13 = 21, ...}
            \begin{onlyenv}<1>
                \kotlinfile{listings/bsp_recursion_1.kts}
            \end{onlyenv}

            \begin{onlyenv}<2>
                \kotlinfile{listings/bsp_recursion_2.kts}
            \end{onlyenv}
...
\begin{frame}
    ...
    \vspace{1em}
    \pause
    \kotlinfile{listings/recursiveSum.kts}
\end{frame}
