\documentclass[accentcolor=tud3c,colorbacktitle,landscape,german,presentation,t,usenames,dvipsnames,svgnames,table]{tudbeamer}
...
\logo[2]{\includegraphics[scale=5]{../globalMedia/bildmarke_ohne_rand}}
...
\newcommand{\slidehead}{\frametitle{\insertsectionhead \\ {\small \insertsubsectionhead}}}
\newcommand{\tocslide}{\begin{frame}[t]\frametitle{Inhaltsverzeichnis}{\small\tableofcontents[subsectionstyle=shaded]}\end{frame}}
