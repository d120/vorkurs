...
%Deckblatt
\titlegraphic{
    \includegraphics[height=\IfDarkModeTF{.8}{.7}\textheight]{bildmarke_ohne_rand\IfDarkModeT{-dark}.png}
}
\maketitle
...
\begin{frame}
    ...
    \begin{columns}[b]
        ...
        \begin{column}{ .4\textwidth }
            \includegraphics[width=\textwidth]{media/bildmarke_ohne_rand\IfDarkModeT{-dark}.png}
        \end{column}
    \end{columns}
\end{frame}
