...
\begin{frame}
	\slidehead
	\pythonfile{listings/list_syntax.py}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\pythonfile{listings/list_length.py}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Beispiel:}
		\pythonfile{listings/simpleSlice.py}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\pause
	\begin{block}{Beispiel:}
		\pythonfile{listings/partlySlice.py}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\pause
	\begin{block}{Beispiel:}
		\pythonfile{listings/intervalSlice.py}
	\end{block}
\end{frame}
