...
\DeclareDocumentCommand{\pythonfile}{O{} O{} m}{\inputCode[#1]{minted language=python,minted style/.expanded=\IfDarkModeTF{native}{friendly},#2}{#3}}
...
\DeclareTCBListing{commandshell}{ O{} O{} }{
    ...
    #2,
    % before upper={\textcolor{TUDa-9b}{\small\ttfamily\bfseries root \$> }},
    % every listing line={\textcolor{TUDa-9b}{\small\ttfamily\bfseries root \$> }}
}
