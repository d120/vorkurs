...
\begin{minipage}[t]{.7\textwidth}
	...
	\smallskip
	Zu Beginn des Spieles werden zwei zufällige unterschiedliche Felder mit $2$ oder $4$ gefüllt.

	\smallskip
	Der/Die Spieler*in kann dann eine Richtung auswählen, in die geschoben wird.
	...
	\smallskip
	Sollte ein Feld an ein weiteres Feld in der Schieberichtung stoßen, welches den gleichen Wert hat so verschmelzen beide Felder zu einem und werden so weit wie möglich in die Schieberichtung geschoben.
\end{minipage}%
...
In jeder weiteren Runde wird ein weiteres zufälliges freies Feld mit $2$ oder $4$ gefüllt, und dann kann wieder geschoben werden.

\textit{Für Bastler(keineswegs erforderlich):} Die Wahrscheinlichkeit, dass einem freien Feld eine $4$ zugewiesen wird ist $10\%$
\subsubsection*{Spielende}
Wenn keine Verschiebung in keine Richtung mehr möglich, und das Spielfeld voll ist, dann ist das Spiel verloren.

Wenn eine Kachel den Wert $2048$ erreicht ist das Spiel gewonnen :D

\subsubsection*{Sonderfälle}

Wenn zwei Felder verschmolzen sind, können sie nicht weiter verschmelzen:
